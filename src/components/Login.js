...
const handleButtonClick = () =>{
  ...
  displayName: name.current.value, photoURL: USER_ICON
      ...
      //fetch all this from the updated value of the user, not the older value
  ...
  .catch((error) => {
    ...
    return <div>
        ...
        className="w-10/12 md:w-4/12 absolute p-9 bg-black my-32 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80">
